...
LG[1:46]<-"L"
LG[47:92]<- "G"
congruency<-character(92)
congruency[1:23]<-"inc"
congruency[47:69]<- "inc"
congruency[24:46]<-"con"
congruency[70:92]<-"con"
...
j+geom_point(size=3)+geom_errorbar(color=c("darkblue","darkblue","blue","blue","darkgreen","darkgreenN","#00CC33","#00CC33"),size=0.7, width=0.5)+theme_classic()+ labs(x="Condition",
...
(SACS)", 
  ...
  xlim(labels=c("G_con","G_inc","L_con","L_inc",
                "G_con","G_inc","L_con","L_inc"))+
